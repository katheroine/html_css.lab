...
1. Elements
    ...
    17. [Paragraph `<p></p>`](html/samples/elements/p/)
    18. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    19. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    20. [Horizontal rule `<hr>`](html/samples/elements/hr/)
