...
1. Elements
    ...
    19. [Paragraph `<p></p>`](html/samples/elements/p/)
    20. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    21. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    22. [Horizontal rule `<hr>`](html/samples/elements/hr/)
