...
1. Elements
    ...
    14. [Paragraph `<p></p>`](html/samples/elements/p/)
    15. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    16. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    17. [Horizontal rule `<hr>`](html/samples/elements/hr/)
