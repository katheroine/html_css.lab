...
1. Elements
    ...
    16. [Paragraph `<p></p>`](html/samples/elements/p/)
    17. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    18. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    19. [Horizontal rule `<hr>`](html/samples/elements/hr/)
