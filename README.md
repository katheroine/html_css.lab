...
1. Elements
    ...
    15. [Paragraph `<p></p>`](html/samples/elements/p/)
    16. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    17. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    18. [Horizontal rule `<hr>`](html/samples/elements/hr/)
