...
1. Elements
    ...
    13. [Paragraph `<p></p>`](html/samples/elements/p/)
    14. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    15. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    16. [Horizontal rule `<hr>`](html/samples/elements/hr/)
