...
1. Elements
    ...
    11. [Paragraph `<p></p>`](html/samples/elements/p/)
    12. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    13. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    14. [Horizontal rule `<hr>`](html/samples/elements/hr/)
