...
1. Elements
    ...
    12. [Paragraph `<p></p>`](html/samples/elements/p/)
    13. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    14. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    15. [Horizontal rule `<hr>`](html/samples/elements/hr/)
