...
1. Elements
    ...
    18. [Paragraph `<p></p>`](html/samples/elements/p/)
    19. [Block quotation `<blockquote></blockquote>`](html/samples/elements/blockquote/)
    20. [Preformatted text `<pre></pre>`](html/samples/elements/pre/)
    21. [Horizontal rule `<hr>`](html/samples/elements/hr/)
